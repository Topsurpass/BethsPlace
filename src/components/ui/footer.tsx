			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
				<div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
					<div className="flex-1">
						...
						<p className="text-foreground mb-6 max-w-md">
							Premium handmade Nigerian bags celebrating craftsmanship and cultural
							heritage.
						</p>
						<div className="flex space-x-4">
							<a
								href="#"
								className="foreground hover:text-gold transition-colors duration-300"
								aria-label="Facebook"
							>
								<svg
									className="w-5 h-5"
				...
				<div className="border-t mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
					...
					<div className="flex space-x-6 mt-4 md:mt-0">
						<Link
							href="/privacy"
							className="text-foreground hover:text-gold text-sm transition-colors duration-300"
						>
							Privacy Policy
						</Link>
						<Link
