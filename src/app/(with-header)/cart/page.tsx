			...
			<div className="min-h-screen pt-20">
				<div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
					<div className="text-center">
						<div className="mx-auto h-18 w-18 md:w-24 md:h-24 mb-6">
							<svg
						...
						<Link
							href="/"
							className="bg-gold-deep text-black font-bold py-2 px-3 md:py-3 md:px-8 rounded-lg hover:bg-gold-light transition-colors duration-300"
						>
							Continue Shopping
						</Link>
					</div>
				...
				<div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
					...
					<div className="lg:col-span-1">
						<div className="bg-background border rounded-lg p-6 sticky top-24">
							...
							<div className="w-full border  py-2 rounded-lg font-bold text-l bg-gold-deep px-3">
								<Link
									href="/checkout"
									className="w-full text-center text-black block"
								>
									Proceed to checkout
								</Link>
							</div>
